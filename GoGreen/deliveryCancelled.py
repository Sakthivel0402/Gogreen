...
print(f"""
    ...
    <div class="sidebar">
        ...
        <a class="active" href="deliveryCancelled.py?id={id}"><i class='bx bx-x'></i> Cancelled Orders</a>
...
""")
q = f"""select * from orders where deliverymanid='{id}' and status='cancelled'"""
cur.execute(q)
query = cur.fetchall()
if query:
    print("""  <h3 class="mt-5">Cancelled Deliveries:</h3>
            <div class="card mt-3">
        <table>
                <thead>
                    <tr>
    ...
    for i in query:
        ...
        print(f"""
            <tr>
                ...
                <td>{i[28]}</td>
                <td>{i[29]}</td>
                <td ><p class="badge bg-danger"> {i[21]}</p></td>
            </tr>
        """)
        sno += 1
    print("""</tbody>
