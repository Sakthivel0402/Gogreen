...
print(f"""
    ...
    <div class="header">
        <h1 class="ms-5" style="color: #fff;">Search Plants & Seeds</h1>
...
print(f"""
    <div class="sidebar">
        ...
        <a class="active" href="./viewPlantsandseeds.py?id={id}"><i class='bx bx-leaf'></i> View Plants & Seeds</a>
        <a  href="./userFindmedicine.py?id={id}"><i class='bx bx-search'></i> Find Medicine Plants</a>
  ...
  <div class="container mt-2 me-1 searchbar-container">
    <form class="searchbar" method="post">
      <input class="form-control h-100 me-2" autocomplete="off" type="search" placeholder="Search any Plants or Seeds" name="product" aria-label="Search">
      <input class="btn btn-secondary button"  type="submit" value="Search">
    </form>
</div>
...
if user:
    ...
    if search:
        p = f"SELECT * FROM products WHERE name LIKE '%{search}%' ORDER BY RAND()"
    else:
