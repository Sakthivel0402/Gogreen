...
<body>
""")
q = f"""SELECT * FROM orders WHERE status='cancelled'"""
cur.execute(q)
query = cur.fetchall()
...
if query:
    print(f"""
    <div class="header">
        <h1 class="ms-5" style="color: #fff;"   >Cancelled Orders</h1>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a class="active" href="./adminCancelledorders.py"><i class='bx bx-x'></i> Cancelled orders</a>
        ...
        for i in query:
            ...
            print(f"""
                    <tr>
                        ...
                        <td>{i[19]}</td>
                        <td>{deli[0]}</td>
                        <td><span class="badge bg-danger">{i[21]}</span></td>
                    </tr>
                """)
            sno+=1
    else:
