...
if query:
    print(f"""
    <div class="header">
        <h1 class="ms-5" style="color: #fff;"   > Details</h1>
    ...
    <div class="sidebar">
        ...
        <a class="active"  href="./adminUserdetails.py"><i class='bx bx-user'></i> User Details</a>
        ...
        for i in query:
            print(f"""
                    <tr>
                        ...
                        <td>{i[5]}</td>
                        <td>{i[6]}</td>
                        <td><button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal{i[0]}">View more</button></td>
                    </tr>
 ...
 <div class="modal fade " id="exampleModal{i[0]}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              ...
              <div > <h5>User name: <span class="span1">{i[1]} </span></h5><h5> DOB: <span class="span1">{i[3]}</span></h5><h5> Gender: <span class="span1">{i[4]}</span><h5> mail: <span class="span1">{i[5]}</span> <h5> phone: <span class="span1">{i[6]}</span></h5> <h5>Address line1: <span class="span1">{i[7]}</span></h5> <h5>Address line2: <span class="span1">{i[8]}</span></h5> <h5>city: <span class="span1">{i[9]}</span></h5> 
                     <h5>Zipcode: <span class="span1">{i[10]}</span></h5> <h5>State: <span class="span1">{i[11]}</span></h5> <h5>Country: <span class="span1">{i[12]}</span></h5> <h5>Username: <span class="span1">{i[13]}</span></h5> <h5>Password: {i[14]}</h5>
                     </div>  
