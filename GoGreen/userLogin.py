        ...
        <div class="container border mt-5 rounded-4  custom-shadow mb-5 blur-effect">
            ...
            <div class="row">
                <div class="ms-5 col-md-10">
                    <img src="assets/user (1).png" class="mb-1" width="15px" alt=""> <label for="" class="form-label mt-5"> Username</label> <br>
            ...
            <div class="row">
                <div class="col-md-10 mt-4 ms-5">
                    ...
                    <div class="col-md-5 mt-3 me-1 float-end">
                        <a href="./userForgotpwd.py" class="text-danger text-decoration-none">Forgot password?</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
if login != None:
    ...
    query = f"""SELECT id, blockstatus FROM userreg WHERE username='{username}' AND password='{password}'"""
    cur.execute(query)
    result = cur.fetchone()
    ...
    if result != None:
        ...
        if blockstatus == "blocked":
            ...
            print(f"""
                ...
                location.href="userDashboard.py?id={userid}"
                </script>
            """)
    else:
        print("""
