...
if query:
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a  class="active" href="./nurseryCompleted.py?id={id}"><i class='bx bx-check'></i> Completed orders</a>
            ...
            print(f"""
                        <tbody>
                            <tr>
                                ...
                                <td>{i[17]}</td>
                                <td>
                                    <span class="badge text-bg-success">{i[21]}</span>
                                </td>
                            </tr>
                        </tbody>""")
        print("""
