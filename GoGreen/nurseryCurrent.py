...
if query:
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            <a href="./nurseryCurrent.py?id={id}" class="active"><i class='bx bx-time'></i> Current orders</a>
    ...
    plants = f"""select * from orders where nurseryid='{nurseryid}' and status='ordered'"""
    cur.execute(plants)
    list = cur.fetchall()
