...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container border mt-5 rounded-4  custom-shadow mb-5 blur-effect">
            <h2 class="text-center mb-4 fw-bold">Delivery Login</h2>
            <div class="row">
                <div class="ms-5 col-md-10">
                    <img src="assets/user (1).png" class="mb-1" width="15px" alt=""> <label for="" class="form-label mt-5"> Employee ID</label> <br>
            ...
            <div class="row">
                <div class="col-md-10 mt-4 ms-5">
                    ...
                    <div class="col-md-5 mt-3 me-1 float-end">
                        <a href="./deliveryForgotpwd.py" class="text-danger text-decoration-none">Forgot password?</a>
                    </div>
                </div>
            </div>
            <div class="row">
...
if login != None:
    ...
    query = f"""SELECT id, employeestatus FROM delireg WHERE employeeID='{username}' AND password='{password}'"""
    cur.execute(query)
    result = cur.fetchone()
    ...
    if result != None:
        ...
        if blockstatus == "blocked":
            print("""
                <script>alert("Delivery person is blocked by the admin.")
                location.href="deliveryLogin.py"
                </script>
            """)
        else:
            print(f"""
                <script>alert("Login Successful!")
                location.href="deliveryDashboard.py?id={userid}"
                </script>
            """)
    else:
        print("""
