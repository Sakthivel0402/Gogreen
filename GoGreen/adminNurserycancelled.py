...
select = f"""select * from nurseryreg where regstatus='declined'"""
cur.execute(select)
query = cur.fetchall()
...
<head>
    ...
    <title>Admin-cancelled nursery requests</title>
...
<body>
    ...
    <div class="header">
        <h1 class="ms-5" style="color: #fff;">  cancelled Nurseries</h1>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a class="active" href="./adminNurserycancelled.py"><i class='bx bx-x-circle'></i> Cancelled nurseries</a>
        </div>
    ...
    for i in query:
        print(f"""
                <tr>
                    ...
                    <td ><p class="badge text-bg-danger">{i[21]}</p></td>
