...
if query:
    ...
    <div class="sidebar">
        ...
        <a  class="active" href="./nurseryReviews.py?id={id}"><i class='bx bx-user-circle'></i>Customer Reviews</a>    
    </div>""")
    ...
    plants = f"""select * from orders where nurseryid='{nurseryid}' and status='completed'"""
    cur.execute(plants)
    list = cur.fetchall()
    ...
    if list:
        print(f"""
         ...
         <h3 class="mb-3">Nursery reviews:</h3>
         <div class="card mt-4">
            ...
            print(f"""
                        <tbody>
                            <tr>
                                ...
                                <td>{i[19]}</td>
                                <td>{i[33]}</td>
                                <td>{i[34]} <i  class='fa-solid fa-star text-warning'></i>
                                </td>
                            </tr>
                        </tbody>""")
            sno += 1
