...
<head>
    ...
    <title> delivery completed requests</title>
...
print(f"""
    ...
    <div class="sidebar">
        ...
        <a class="active" href="./deliveryCompleted.py?id={id}"><i class='bx bx-check'></i> Completed Orders</a>
...
""")
q = f"""select * from orders where deliverymanid='{id}' and status='completed'"""
cur.execute(q)
query = cur.fetchall()
if query:
    print("""  <h3 class="mt-5">Completed Deliveries:</h3>
            <div class="card mt-3">
        <table>
                <thead>
                    <tr>
