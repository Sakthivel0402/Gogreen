...
<head>
    ...
    <title>Nursery forgot password</title>
...
if submit != None:
        ...
        query = f"""select * from nurseryreg where mail='{mail}'"""
        cur.execute(query)
        sts = cur.fetchone()
        if sts[4]:
            password = sts[20]
            ...
            body = f"Hello {name}!.\n We are successfully found your password: {password} for the Nursery ID: {userid}"
            ...
            location.href="nurseryLogin.py"</script>""")
