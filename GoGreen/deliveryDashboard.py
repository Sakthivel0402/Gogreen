...
<head>
    ...
    <title>Go Green delivery Dashboard</title>
...
print(f"""
    ...
    <div class="sidebar">
        ...
        <a href="deliveryDashboard.py?id={id}" class="mt-4 active"><i class='bx bx-home'></i> Home</a>
...
print(f"""    
    <div class="main-content">
           <h3>Welcome,</h3> <h2 class="fw-bold"> {name}! ({deliID})</h2>
           
           <div class="card mt-4">
                <h3>View Pending Requests</h3>
                <p>View new requests from users.</p>
                <a href="./deliveryPendingrequests.py?id={id}" class="btn">Pending requests</a>
            </div>
            <div class="card">
                <h3>Recent Orders</h3>
                <p>View and manage orders placed by customers.</p>
                <a href="./deliveryOngoing.py?id={id}" class="btn">View Orders</a>
            </div>
            <div class="card">
                <h3>Completed Orders</h3>
                <p>View recently completed orders.</p>
                <a href="./deliveryCompleted.py?id={id}" class="btn">View Details</a>
            </div>
        </div>
