...
if query:
    print(f"""
    <div class="header">
        <h1 class="ms-5" style="color: #fff;"   >Completed Orders</h1>
    ...
    <div class="sidebar">
        ...
        <div class="dropdown-container">
            ...
            <a class="active" href="./adminCompleted.py"><i class='bx bx-check'></i> Completed orders</a>
        ...
        for i in query:
            ...
            print(f"""
                    <tr>
                        ...
                        <td>{i[19]}</td>
                        <td>{deli[0]}</td>
                        <td><span class="badge bg-success">{i[21]}</span></td>
                    </tr>
                """)
            sno += 1
    else:
